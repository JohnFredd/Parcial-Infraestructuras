    ...
    with yt_dlp.YoutubeDL(ydl_opts) as ydl:
        ...
        if videos:
            for video in videos:
                ...
                # Escribir información del video al registro con formato "Video: ..."
...
def main(num_procesos):
    carpeta_descarga = 'downloadP_videos'
    os.makedirs(carpeta_descarga, exist_ok=True)
    registro_path = 'MultiprocesadoresRegistro.txt'
    ...
    for canal in canales_data['channels']:
        proceso = Process(target=recorrer_canales, args=(canal, carpeta_descarga, registro_path))
